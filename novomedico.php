...
$statement = $pdo->prepare('INSERT INTO medicos(crm_medico, nome_medico, conselho_medico, uf_crm_medico) VALUES (:crm_medico, :nome_medico, :conselho_medico, :uf_crm_medico)');
  ...
  <div class="row">
    ...
    <ul class="breadcrumb">
        ...
        <li>
         ...
         <li>
            <a href="novomedicos.php">Novo medicos</a>
        </li>
    </ul>
</div>
