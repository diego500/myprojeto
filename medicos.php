...
function funcaoview(get) {
  ...
  window.open('http://localhost/Clinica/myprojeto/viewmedico.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
}

function funcaoedita(get) {
	
	 window.open('http://localhost/Clinica/myprojeto/editamedico.php?id='+get+'', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=650, HEIGHT=400'
  ); 
...
function funcaodeleta(get) {
	...
	function funcaonova() {
	 ...
	 window.location.assign("http://localhost/Clinica/myprojeto/novomedico.php");
